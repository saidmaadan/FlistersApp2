...
class CalendarModal extends Component {
  ...
  componentWillMount() {
    ...
    this.props.getReservations(selectedListingId);
  }
  ...
  onReservationPress(reservation) {
    ...
    Alert.alert(
      ...
      [
        {text: 'Decline', onPress: () => changeReservation(selectedListingId, reservation.id, false)},
        {text: 'Approve', onPress: () => changeReservation(selectedListingId, reservation.id, true)},
      ]
    );
  }
  ...
  render() {
    ...
    //     guest: {
    //       fullname: "Said M",
    //       avatar: "http://gravatar.com/avatar/said@m.com"
    //     },
    //     total: 500,
              ...
              <View style = {styles.details}>
                {
                  ...
                  <TouchableOpacity
                    ...
                    <View style = { styles.info }>
                      <Text style = { styles.name }>{reservation.guest.full_name}</Text>
...
const mapDispatchToProps = dispatch => ({
  getReservations: (listingId) => dispatch(getReservations(listingId)),
  changeReservation: (listingId, reservationId, approve) => dispatch(changeReservation(listingId, reservationId, approve)),
});
